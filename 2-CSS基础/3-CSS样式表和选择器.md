...
-   （1）**采用`<link>`标签**。例如：`<link rel = "stylesheet" type = "text/css" href = "a.css">`
...
```html
  ...
  <link rel = "alternate stylesheet" type = "text/css" href = "b.css" title="第二种样式">
  <link rel = "alternate stylesheet" type = "text/css" href = "c.css" title="第三种样式">
```
